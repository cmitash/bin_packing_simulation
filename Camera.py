...
class Camera:
    ...
    def write_object_pose(self, filepath, me_ob, index, cam_pose):
        ...
        return np.array([[object_pose_camera[0][0], object_pose_camera[0][1], object_pose_camera[0][2],object_pose_camera[0][3]],
                        [object_pose_camera[1][0], object_pose_camera[1][1], object_pose_camera[1][2],object_pose_camera[1][3]],
                        [object_pose_camera[2][0], object_pose_camera[2][1], object_pose_camera[2][2],object_pose_camera[2][3]]])
